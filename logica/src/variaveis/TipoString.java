...
public class TipoString {
	...
	public static void main(String[] args) {
		...
		String email = "aline.a.ribeiro@itau-unibanco.com.br";
		...
		System.out.println("Do 2 até o 5 caracter: " + email.substring(1,5));
		...
		//exibir somento servidor
		System.out.println("Exibir somente o servidor: " + email.substring(email.indexOf("@")+1,email.length()));
